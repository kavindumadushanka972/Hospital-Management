        ...
        >
          <Modal.Body >
              ...
              <Form.Group as={Row} className="mb-3" style={{ marginLeft: "4%", width: "90%" }}>
                ...
                <Col sm={10}>
                  <Form.Control size="30" placeholder="Enter full name" value={this.state.fullname} name="fullname" onChange={this.handleChange} style={{ marginLeft: "5%", width: "90%", marginTop: "20px" }} required />
                </Col>
              </Form.Group>
              ...
              <Form.Group as={Row} className="mb-3" style={{ marginLeft: "4%", width: "90%" }}>
                ...
                <Col sm={10}>
                  <Form.Control type="email" placeholder="Enter your email" value={this.state.email} name="email" required onChange={this.handleChange} style={{ marginLeft: "5%", width: "90%", marginTop: "20px" }} readOnly />
                </Col>
              </Form.Group>
              ...
              <Form.Group as={Row} className="mb-3" style={{ marginLeft: "4%", width: "90%" }}>
                ...
                <Col sm={10}>
                  <Form.Control placeholder="Enter your address" value={this.state.address} name="address" onChange={this.handleChange} style={{ marginLeft: "5%", width: "90%", marginTop: "20px" }} required />
                </Col>
              </Form.Group>
              ...
              <Form.Group as={Row} className="mb-3" style={{ marginLeft: "4%", width: "90%" }}>
                ...
                <Col sm={10}>
                  <Form.Control placeholder="Enter zip code" value={this.state.zipcode} name="zipcode" onChange={this.handleChange} style={{ marginLeft: "5%", width: "90%", marginTop: "20px" }} required />
                </Col>
              </Form.Group>
              ...
              <Form.Group as={Row} className="mb-3" style={{ marginLeft: "4%", width: "90%" }}>
                ...
                <Col sm={10}>
                  <Form.Control placeholder="Enter your NIC number" value={this.state.nicNumber} name="nicNumber" onChange={this.handleChange} style={{ marginLeft: "5%", width: "90%", marginTop: "20px" }} required />
                </Col>
              </Form.Group>
